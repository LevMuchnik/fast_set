function [c, ia, ib] = fast_setdiff_sorted(a,b)
%	Returns a list of values contained in a but not in b.
%	Very efficient (usually, 3-17 times faster) replacement of the standard MatLab setdiff function. 
% 
%
%	Receives:
...
% Example:
%
% 	b = uint32([3 : 5 : 2000000]); 
% 	a = uint32([1: 3 : 2000000]); 
% 	tic, 
% 	[c, ai]= setdiff(a,b); 
% 	t1 = toc; tic, 
